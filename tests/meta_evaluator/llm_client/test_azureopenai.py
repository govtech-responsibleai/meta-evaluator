...
class TestAzureOpenAIClient:
    ...
    @pytest.fixture
    def valid_azure_config(self) -> AzureOpenAIConfig:
    ...
    def test_client_initialization(
        ...
        assert client.config == valid_azure_config
        assert isinstance(client.config, AzureOpenAIConfig)

    def test_enum_value_property(self, valid_azure_config: AzureOpenAIConfig) -> None:
    ...
    def test_convert_messages_to_openai_format(
        self, valid_azure_config: AzureOpenAIConfig, sample_messages: list[Message]
    ) -> None:
    ...
    def test_convert_empty_messages_list(
        self, valid_azure_config: AzureOpenAIConfig
    ) -> None:
