...
class TestJudgeSyncEvaluation:
    """Test suite for synchronous evaluation methods in Judge class."""
    ...
    @patch("meta_evaluator.judge.sync_evaluator.completion")
    ...
    def test_structured_success(
        ...
        """Test structured evaluation with default model - success path."""
    ...
    @patch("meta_evaluator.judge.sync_evaluator.instructor")
    def test_instructor_success(
        self,
        mock_instructor,
        instructor_judge,
        basic_eval_data,
        ...
        """Test instructor evaluation with default model - success path."""
        ...
        instructor_judge._evaluate_row_instructor(
            row=sample_row,
            eval_data=basic_eval_data,
            sample_example_id="test_1",
            task_class=task_class,
    ...
    def test_xml_success(
        ...
        """Test XML evaluation with default model - success path."""
        mock_completion.return_value = mock_xml_litellm_response
    ...
    @patch("meta_evaluator.judge.sync_evaluator.completion")
    @patch("meta_evaluator.judge.sync_evaluator.supports_response_schema")
    def test_structured_api_call_fails(
        self,
        mock_supports,
        mock_completion,
        template_basic_judge,
        ...
        """Test structured evaluation handles API call failure."""
        mock_supports.return_value = True
    ...
    @patch("meta_evaluator.judge.sync_evaluator.completion")
    @patch("meta_evaluator.judge.sync_evaluator.supports_response_schema")
    def test_structured_partial_success(
        self,
        mock_supports,
        mock_completion,
        ...
        multi_judge._evaluate_row_structured(
            row=sample_row,
            eval_data=basic_eval_data,
            sample_example_id="test_1",
            task_class=task_class,
    ...
    @patch("meta_evaluator.judge.sync_evaluator.instructor")
    def test_instructor_partial_success(
        self,
        mock_instructor,
        multi_task_eval_task,
        basic_eval_data,
    ...
    def test_empty_dataset_with_skip_all(self, template_sentiment_judge_prompt):
        ...
        result = skip_judge.evaluate_eval_data(eval_data, "test_run")
    ...
    @patch("meta_evaluator.judge.sync_evaluator.instructor")
    @patch("meta_evaluator.judge.sync_evaluator.supports_response_schema")
    def test_fallback_chain_structured_to_instructor_to_xml(
        self,
        mock_supports,
        mock_instructor,
        mock_completion,
        ...
        """Test full fallback chain: structured -> instructor -> XML when each method fails."""
        ...
        mock_client = Mock()
        mock_instructor.from_provider.return_value = mock_client
        mock_client.chat.completions.create.side_effect = Exception("Instructor failed")

        # 3. Mock XML completion to succeed
        ...
        mock_completion.return_value = mock_xml_response
        ...
        fallback_judge._evaluate_row_with_fallback(
            row=sample_row,
            eval_data=basic_eval_data,
            sample_example_id="test_1",
            task_class=task_class,
        ...
        # 3. XML completion was called (final fallback)
        mock_completion.assert_called_once()
