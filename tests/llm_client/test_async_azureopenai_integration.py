"""Integration tests for AsyncAzureOpenAIClient with real API calls."""
...
class TestAsyncAzureOpenAIIntegration:
    """Integration tests for AsyncAzureOpenAIClient using real API calls."""

    @pytest.mark.asyncio
    async def test_chat_completion_integration(self, async_azure_client_integration):
        ...
        response = await async_azure_client_integration.prompt(messages)
    ...
    @pytest.mark.asyncio
    async def test_structured_output_integration(self, async_azure_client_integration):
        ...
        (
            structured_response,
            llm_response,
        ) = await async_azure_client_integration.prompt_with_structured_response(
    ...
    @pytest.mark.asyncio
    async def test_embedding_integration(self, async_azure_client_integration):
        """Test async embedding generation with real API."""
        texts = ["Hello world", "This is a test"]

        embeddings = await async_azure_client_integration.get_embedding(texts)
