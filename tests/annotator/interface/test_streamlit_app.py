...
class TestAnnotationLogic:
    ...
    def test_handle_annotation_with_complete_data(
        ...
        mock_session_manager.create_success_row = Mock()
        mock_session_manager.current_row = 0
        mock_session_manager.has_user_session = True  # Required for auto-save functionality
        ...
        with patch(
            ...
            with patch.object(annotator, "display_radio_buttons"):
                with patch.object(annotator, "display_free_form_text"):
                    with patch.object(annotator, "_auto_save_annotation") as mock_auto_save:
...
class TestAutoSave:
    ...
    def test_generate_auto_save_filename(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_generate_auto_save_filename_without_session_raises_error(
        ...
        with patch(
            ...
            with pytest.raises(RuntimeError, match="Cannot generate auto-save filename without user session"):
                annotator._generate_auto_save_filename("test_user")

    def test_set_auto_save_filename(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_load_auto_save_results_success(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_load_auto_save_results_empty_file(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_load_auto_save_results_invalid_file(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_auto_save_annotation_saves_data(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
        ...
        with patch(
            ...
            with patch('streamlit.success') as mock_success:
                annotator._auto_save_annotation("id1", {"sentiment": "positive", "quality": "good"})
    ...
    def test_auto_save_annotation_without_session(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_auto_save_annotation_sets_filename_if_none(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_initialization_loads_existing_auto_save(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_initialization_no_auto_save_found(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
        ...
        with patch(
            ...
            if not mock_session_manager.has_user_session:
                ...
                expected_auto_save_file = annotator._generate_auto_save_filename(annotator.annotator_name)
    ...
    def test_save_annotations_data_parquet_format(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
    ...
    def test_find_existing_auto_save_file(self, mock_eval_data, mock_eval_task, temp_annotations_dir):
        ...
        with patch(
            ...
            file1 = os.path.join(temp_annotations_dir, "autosave_run1_annotator1_john_data.parquet")
            file2 = os.path.join(temp_annotations_dir, "autosave_run2_annotator2_john_data.parquet")
            file3 = os.path.join(temp_annotations_dir, "autosave_run3_annotator3_jane_data.parquet")
